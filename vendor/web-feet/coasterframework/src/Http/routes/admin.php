...
Route::group(['prefix' => $adminUrl, 'middleware' => ['web', 'coaster.admin'], 'namespace' => $adminController], function () use($adminUrl, $routeNamePrefix) {
    ...
    Route::post('sizes/edit', ['uses' => 'SizesController@postUpdate', 'as' => $routeNamePrefix . 'sizes.edit']);
    Route::get('sizes/add', ['uses' => 'SizesController@getAdd', 'as' => $routeNamePrefix . 'sizes.add']);
    ...
    Route::get('teams/csv', ['uses' => 'TeamsController@getCsv', 'as' => $routeNamePrefix . 'teams.csv']);
