...
?>
			...
			?>		<figure data-name="<?php echo $file ?>" data-type="<?php if($is_img){ echo "img"; }else{ echo "file"; } ?>">
				...
				<figcaption>
					...
					<a href="javascript:void('')" class="tip-left erase-button <?php if($delete_files && !$file_prevent_delete) echo "delete-file";?>" title="<?php echo transfm('Erase')?>" data-confirm="<?php echo transfm('Confirm_del');?>" data-path="<?php echo $rfm_subfolder.$subdir.$file;?>">
